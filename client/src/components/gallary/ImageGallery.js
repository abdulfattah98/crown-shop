...
import SVG from './ImageGallerySVG';
    ...
    getThumbsTranslate(indexDifference) {
        ...
        if (thumbElement) {
            ...
            if (this.isThumbnailVertical()) {
                ...
                totalScroll =
                    thumbElement.scrollHeight - thumbnailsWrapperHeight;
            } else {
                if (
        ...
        const slideWrapper = (
            ...
            >
                ...
                {this.canSlide() ? (
                    ...
                    <div className="image-gallery-slides">
                        <span className="hover-to-zoom">hover to zoom</span>
                        {slides}
                    </div>
                )}
                {showPlayButton &&
